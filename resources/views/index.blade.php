...
<body style="background-color: #01192b;">
  ...
  {{-- header survey end --}}
  <div class="container mt-4 mb-4 m-auto" id="wrapper">
  ...
  <script>
    function setHexagon() {
      ...
      if (wrapperEl) {
        ...
        if (hexagonEl) {
          hexagonEl.style.borderLeft = `${(rect.width / 2) - 12}px solid transparent`;
          hexagonEl.style.borderRight = `${(rect.width / 2) - 12}px solid transparent`;
        }
      }
    }
