...
class SurveyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'logo_kanan' => 'required|image|mimes:jpeg,png,jpg,gif,svg|max:2048',
        ...
        if($logoKiri = $request->file('logo_kiri'))
        {
            ...
            $pmLogoKiri = date('YmdHis').".".$logoKiri->getClientOriginalExtension();
        ...
        if ($logoKanan = $request->file('logo_kanan'))
        {
            ...
            $pmLogoKanan = date('YmdhHis').".".$logoKanan->getClientOriginalExtension();
        ...
        if ($emotsatu = $request->file('emot_1'))
        {
            ...
            $pmEmotSatu = date('YmdhHis').".".$emotsatu->getClientOriginalExtension();
        ...
        if ($emotdua = $request->file('emot_2'))
        {
            ...
            $pmEmotDua = date('YmdhHis').".".$emotdua->getClientOriginalExtension();
        ...
        if ($emottiga = $request->file('emot_3'))
        {
            ...
            $pmEmotTiga = date('YmdhHis').".".$emottiga->getClientOriginalExtension();
        ...
        if ($emotempat = $request->file('emot_4'))
        {
            ...
            $pmEmotEmpat = date('YmdhHis').".".$emotempat->getClientOriginalExtension();
        ...
        if ($emotlima = $request->file('emot_5'))
        {
            ...
            $pmEmotLima = date('YmdhHis').".".$emotlima->getClientOriginalExtension();
